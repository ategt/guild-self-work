...
//import com.thesoftwareguild.AddressBookUI.App;
...
//    AddressBookDao dao = ctx.getBean("addressDao", AddressBookDaoImpl.class);
    ApplicationContext ctx = new ClassPathXmlApplicationContext("applicationContext.xml");
    AddressBookDao dao = ctx.getBean("addressDao", AddressBookImpl.class);
    ...
    public void tearDown() {
        ...
        try {
            try (PrintWriter out = new PrintWriter(new FileWriter("testAddresses2.txt"))) {
                out.flush();
            }

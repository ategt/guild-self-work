...
public class LuckySevensJUnitTest {
    ...
    public void testLuckySevens() {
        ...
        //com.mycompany.labs.LuckySevens ls = (LuckySevens) ctx.getBean("luckySevens");   //ctx.getBean("luckySevens", LuckySevens.class);
        com.mycompany.labs.LuckySevens ls = ctx.getBean("luckySevens", com.mycompany.labs.LuckySevens.class);//ctx.getBean("luckySevens", LuckySevens.class);

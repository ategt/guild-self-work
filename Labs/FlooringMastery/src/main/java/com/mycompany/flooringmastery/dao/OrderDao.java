...
////        }
//        
//        java.util.List<java.util.Date> filteredOrderDates = new ArrayList();
//        java.util.List<String> filteredOrderDateStrings = new ArrayList();
//        
//        for (java.util.Date orderDate : orderDates ){
//            if (filteredOrderDates.contains(fmt)){
//                
//            }
//            
//        }
